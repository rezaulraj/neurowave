          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 leading-relaxed max-w-lg">
                ...
                should feel effortless to use and be built on a foundation
                that never breaks. Today we partner with startups and growing
              ...
              <div className="relative grid grid-cols-2 gap-6">
                ...
                <div className="space-y-6 pt-10">
                  ...
                  <div className="bg-white rounded-3xl shadow-lg p-6 border border-gray-100">
                    ...
                    <p className="text-sm text-gray-600">
                      Quality, transparency, and results — every project,
                      every time.
                    </p>
                  </div>
                </div>
      ...
      <section className="relative bg-white py-20 overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              A small team with big ambitions — and the track record to back
              it up.
            </p>
          </motion.div>
